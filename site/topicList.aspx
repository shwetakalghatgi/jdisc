...
<table style=" position:relative; height: 249px; width: 689px; margin-left:0px; top: 0px; left: -58px;">  
    <tr>
     <td  style="margin-left:0px; height: 28px;" align="left">
  ...
  <asp:TemplateField HeaderText="Title">
            <ItemTemplate>
                <asp:HyperLink ID="hl" runat="server" Text='<%# Eval("title") %>'  NavigateUrl='<%# Eval("title", "~/topicContent.aspx?title={0}")%>'></asp:HyperLink>
